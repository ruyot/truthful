...
const Hyperspeed: React.FC<HyperspeedProps> = ({ 
  effectOptions = hyperspeedPresets.purple,
  className = "",
  style = {}
}) => {
  ...
  useEffect(() => {
    ...
    const selectedDistortion = distortions[effectOptions.distortion] || distortions.turbulentDistortion;
    const finalOptions = { ...effectOptions, distortion: selectedDistortion };
    
    const myApp = new App(hyperspeed.current, finalOptions);
