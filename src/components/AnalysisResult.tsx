...
import { CheckCircle, AlertTriangle, XCircle, Clock, Eye, BarChart3, ExternalLink } from 'lucide-react'
...
export const AnalysisResult: React.FC<AnalysisResultProps> = ({ result }) => {
  ...
  const highConfidenceTimestamps = analysis_results.timestamps.filter(t => t.likelihood > 70)
  ...
  return (
    <div className="bg-white rounded-2xl p-8 shadow-lg">
      ...
      {highConfidenceTimestamps.length === 0 && overall_likelihood < 30 && (
        <div className="mt-6 bg-green-50 border border-green-200 rounded-xl p-4">
          <h3 className="text-lg font-semibold text-green-800 mb-2">✅ Clean Analysis</h3>
